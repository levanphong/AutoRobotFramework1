...
*** Test Cases ***
Verify that Skip Next Question is not available on Multiple Path (Prioritized Location) conversation when ATS Mapping tool is added (Data Processing method is not 'Yes/No') (OL-T13265)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
...
Verify that Skip Next Question is not available on Multiple Path (Prioritized Location) conversation when List Select tool is not added (OL-T13267)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify that Skip Next Question is copied when duplicating Multiple Path (Prioritized Location) conversation (OL-T13269)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify Edit Skip Next Question Condition Builder when List Select tool is added in Multiple Path (Prioritized Location) conversation (OL-T13272)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify that Skip Next question condition builder is not saved when canceling instead of saving for Multiple Path (Prioritized Location) conversation (OL-T13276)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check remove Skip Next Question function in Multiple Path (Prioritized Location) conversation (OL-T13277)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check validate when adding duplicate condition in Multiple Path (Prioritized Location) conversation (OL-T13278)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check validate when applying Skip Next Question condition builder without inputting condition for Multiple Path (Prioritized Location) conversation (OL-T13279)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check that Skip Next Question function is removed when changing Data Processing Method in Multiple Path (Prioritized Location) conversation (OL-T13280)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check that cannot change tool from list select to another once list select is used in Skip Next Question conditions for Multiple Path (Prioritized Location) conversation (OL-T13281)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Skip Next Question function is removed when deleting Data Processing Method in Multiple Path (Prioritized Location) conversation (OL-T13282)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check that cannot remove list select tool once it is used in Skip Next Question conditions for Multiple Path (Prioritized Location) conversation (OL-T13283)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check hide the next question when the current question has Skip Next question function in Multiple Path (Prioritized Location) conversation (OL-T13285)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Check delete the next question when the current question has Skip Next question function in Multiple Path (Prioritized Location) conversation (OL-T13286)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify New Skip Next Question flow when starting Multiple Path (Prioritized Location) conversation and selecting option matching with setting (OL-T13287)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify New Skip Next Question flow when starting Multiple Path (Prioritized Location) conversation and selecting the option not matching with setting (OL-T13288)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify Skip Next Question flow when starting Multiple Path (Prioritized Location) conversation and selecting multiple options matching with setting (OL-T13289)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify Skip Next Question flow when starting Multiple Path (Prioritized Location) conversation and selecting multiple options not matching with setting (OL-T13290)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify Skip Next Question flow when starting Multiple Path (Prioritized Location) conversation and input text matching with setting (OL-T13291)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify Skip Next Question flow when starting Multiple Path (Prioritized Location) conversation and input text not matching with setting (OL-T13292)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
...
Verify Skip Next Question flow when starting Multiple Path (Prioritized Location) conversation with OR in Skip Next Question builder (OL-T13293)
    Given Setup test
    when Login into system with company    ${PARADOX_ADMIN}    ${COMPANY_EVENT}
    ${conversation_name} =    Add Multiple Path conversation    Multiple Path (Prioritized Location)
    Go to conversation builder
