...
*** Test Cases ***
Check User has Legacy role "Edit everything" has full access perm to Dashboard - Dashboard on the Analytics and Reporting page (OL-T19549)
    Given Setup test
...
Check User has Legacy role "Edit everything" has full access perm to Dashboard - Hire on the Analytics and Reporting page (OL-T19563)
    Given Setup test
    when Login into system with company    Full User - Edit Everything    ${COMPANY_FRANCHISE_ON}
    Go to Analytics and Reporting page
...
Check User has Legacy role "Edit everything" has full access perm to Rating Dashboard on the Analytics and Reporting page (OL-T19558)
    Given Setup test
    when Login into system with company    Full User - Edit Everything    ${COMPANY_FRANCHISE_ON}
    Go to Analytics and Reporting page
...
Check User has Legacy role "Edit everything" has full access perm to Scheduling Dashboard on the Analytics and Reporting page (OL-T19553)
    Given Setup test
    when Login into system with company    Full User - Edit Everything    ${COMPANY_FRANCHISE_ON}
    Go to Analytics and Reporting page
...
*** Keywords ***
Check Category and Report in Create new report for Edit everything role
    ...
    ELSE
        ...
        Check Report types is correctly for Edit everything role  ${category_type}
    END

Check Report types is correctly for Edit everything role
    [Arguments]  ${category_type}=Admin
    ...
    ELSE IF  '${category_type}' == 'Forms'
        ...
        Click on span text  User Forms Detail
        ${report_email_subject} =   Set variable    FormsCandidate.User.Forms.Detail
    ...
    ELSE IF  '${category_type}' == 'Workflow'
        ...
        Click on span text  Workflow Configuration
