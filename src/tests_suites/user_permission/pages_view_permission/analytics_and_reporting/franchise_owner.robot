...
*** Test Cases ***
Check User has Legacy role "Franchise Owner" has full access perm to Dashboard - Dashboard on the Analytics and Reporting page (OL-T19550)
    Given Setup test
...
Check User has Legacy role "Franchise Owner" has full access perm to Dashboard - Hire on the Analytics and Reporting page (OL-T19564)
    Given Setup test
    when Login into system with company    Franchise Owner    ${COMPANY_FRANCHISE_ON}
    Go to Analytics and Reporting page
...
Check User has Legacy role "Franchise Owner" has full access perm to Rating Dashboard on the Analytics and Reporting page (OL-T19559)
    Given Setup test
    when Login into system with company    Franchise Owner    ${COMPANY_FRANCHISE_ON}
    Go to Analytics and Reporting page
...
Check User has Legacy role "FO" has no access perm to Scheduling Dashboard on the Analytics and Reporting page (OL-T19554)
    Given Setup test
    when Login into system with company    Franchise Owner    ${COMPANY_FRANCHISE_ON}
    Go to Analytics and Reporting page
...
*** Keywords ***
Check Category and Report in Create new report for Franchise Owner role
    ...
    ELSE
        ...
        Check Report types is correctly for Franchise Owner role  ${category_type}
    END

Check Report types is correctly for Franchise Owner role
    [Arguments]  ${category_type}=Admin
